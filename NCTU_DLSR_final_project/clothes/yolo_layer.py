...
class YoloLayer(nn.Module):
    ...
    def forward(self, output, target):
        ...
        # ctsun
        # torch 0.4.0
        #loss_coord = nn.MSELoss(reduce=True, size_average=False)(coord*coord_mask, tcoord*coord_mask)/nB
        #loss_conf  = nn.BCELoss(reduce=True, size_average=False)(conf*conf_mask, tconf*conf_mask)/nB
        #loss_cls   = nn.BCEWithLogitsLoss(reduce=True, size_average=False)(cls, tcls)/nB
        # torch 0.4.1
